            ...
            <div class="row g-4">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-3">
                        ...
                        <span id="component-count" class="badge bg-secondary fw-normal" style="font-size: 11px;">{{ $form->fields->count() }} komponen</span>
                    </div>
                                    ...
                                    <div class="fb-field card border-0 shadow-sm p-3 position-relative" style="background: white; border-radius: 12px;">
                                        <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                <span class="badge bg-primary bg-opacity-10 text-primary">{{ ucfirst($field->type) }}</span>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label small" for="req_{{ $loop->index }}">Wajib Diisi</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
