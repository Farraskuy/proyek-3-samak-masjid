            ...
            <div class="col-lg-8">
                <div class="card bg-white border-0 rounded-3 p-4 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="item_name" class="form-control input-lg" value="{{ old('item_name') }}" required placeholder="Contoh: Dompet Hitam Kulit">
                        @error('item_name')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control" rows="4" required placeholder="Jelaskan ciri-ciri barang secara detail...">{{ old('description') }}</textarea>
                        @error('description')
                        <div class="text-danger mt-1 small">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="location_lost" class="form-control input-lg" value="{{ old('location_lost') }}" required placeholder="Contoh: Area Wudhu Pria">
                        @error('location_lost')
                        <div class="text-danger mt-1 small">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card bg-white border-0 rounded-3 p-4 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="lost_at" class="form-control input-lg" value="{{ old('lost_at', date('Y-m-d')) }}" required>
                        @error('lost_at')
                        <div class="text-danger mt-1 small">{{ $message }}</div>
                        @enderror
                    </div>
