...
@section('content')
    <section class="p-5 position-relative">
        ...
        <div class="rounded-3 bg-white p-4 border- shadow-sm d-flex flex-wrap" style="gap: 20px;">
            ...
            @if (Auth::user()->hasPermission('view_posts') || Auth::user()->hasPermission('view_pages') || Auth::user()->hasPermission('view_gallery') || Auth::user()->hasPermission('view_events'))
            ...
            @if (Auth::user()->hasPermission('view_donation') || Auth::user()->hasPermission('view_expense') || Auth::user()->hasPermission('view_income'))
                <div class="flex-grow-1" style="min-width: 300px;">
                ...
                <div class="d-flex gap-3 mb-3 py-2 bg-light rounded-3 flex-wrap w-100">
                    ...
                    @can('view_consultations')
                        <a href="{{ route('admin.consultations.index') }}" class="btn text-start home-item">
                            ...
                            <div>
                                <p class="fw-semibold m-0">Kotak Masuk Konsultasi <i class="fa-regular fa-arrow-right"></i>
                                </p>
