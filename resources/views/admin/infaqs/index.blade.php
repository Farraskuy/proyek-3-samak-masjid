...
@section('content')
    <section class="p-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-semibold mb-0">Kelola Program Infaq</h4>
            <a href="{{ route('admin.infaqs.create') }}" class="btn btn-success fw-semibold">
        ...
        @php
            ...
            $makeLink = function ($status) {
                return route('admin.infaqs.index', array_merge(request()->query(), ['status' => $status, 'page' => 1]));
            };
        @endphp
        ...
        <div class="d-flex gap-2 mb-4 p-2 rounded-pill" style="background-color: rgba(0,0,0,0.05); width: fit-content;">
            ...
            <a href="{{ $makeLink('active') }}"
                class="btn btn-sm {{ $currentStatus == 'active' ? 'btn-dark' : 'btn-light text-secondary' }} rounded-pill px-4 fw-semibold">
                Aktif
            </a>
            <a href="{{ $makeLink('inactive') }}"
                class="btn btn-sm {{ $currentStatus == 'inactive' ? 'btn-dark' : 'btn-light text-secondary' }} rounded-pill px-4 fw-semibold">
                Nonaktif
            </a>
        </div>
                            ...
                            @forelse($infaqs as $index => $infaq)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="text-danger small"><i class="fas fa-exclamation-circle"></i>
                                                Rekening dihapus</span>
                                        @endif
                                    </td>
                                    <td>
                                        @if ($infaq->is_active)
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex justify-content-end gap-1">
                                            ...
                                            <button type="button"
                                                ...
                                                data-action="{{ route('admin.infaqs.destroy', $infaq->id) }}"
                                                title="Hapus">
