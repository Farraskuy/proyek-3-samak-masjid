    ...
    <section class="p-3 container">
        <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
            ...
            <div class="d-flex align-items-center gap-2 mb-4">
                ...
                <h4 class="fw-semibold mb-0">Edit Role: {{ $role->alias }}</h4>
            </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="card bg-white border-0 rounded-3 p-4 mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control py-2 px-3 @error('alias') is-invalid @enderror"
                                    id="alias" name="alias" value="{{ old('alias', $role->alias) }}" required
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                rows="3" placeholder="Deskripsi singkat tentang role ini...">{{ old('description', $role->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card h-100 border-0 shadow-sm">
                                        ...
                                        <div class="card-header py-2 border-bottom-0 d-flex justify-content-between align-items-center"
                                            ...
                                            <h6 class="m-0 fw-semibold" style="font-size: 14px;">{{ $group }}
                                                Akses</h6>
                ...
                <div class="col-lg-4">
                    <div class="card bg-white border-0 rounded-3 p-4 mb-4">
                        <h5 class="fw-semibold mb-3">Update</h5>
                        ...
                        <button type="submit" class="btn btn-warning w-100 mt-2">
                            <i class="fas fa-save me-1"></i> Perbarui Role
                        </button>
                    </div>
                </div>
            </div>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Function to update "Select All" checkbox state based on group items
                ...
                document.querySelectorAll('.permission-item').forEach(itemCheckbox => {
                    itemCheckbox.addEventListener('change', function() {
                        let groupClass = Array.from(this.classList).find(cls => cls.startsWith(
                            'group-'));
                        if (groupClass) {
