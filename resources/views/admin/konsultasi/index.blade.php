...
@section('content')
    @php
        $columns = ['#','Nama Pengirim','Judul','Tanggal','Status','Aksi'];
    @endphp

    <section class="p-3">
        <h4 class="fw-semibold">Konsultasi</h4>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center">
                                        <div class="py-4">
                                            <img src="data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='220' height='120'><rect width='100%' height='100%' fill='%23f8f9fa'/><text x='50%' y='50%' dominant-baseline='middle' text-anchor='middle' font-family='Arial, Helvetica, sans-serif' font-size='14' fill='%23999'>Tidak ada data</text></svg>" alt="No data" style="max-width:220px;">
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
