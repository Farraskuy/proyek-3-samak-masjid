...
<section class="d-flex align-items-center py-5 py-md-6 hero-animate bg-pattern"
    style="background-color: #175C9E; min-height: 400px;">
        ...
        <div class="row justify-content-center text-center">
            ...
            <div class="col-lg-10">
                ...
                <p class="lead text-white-50 mb-5 col-lg-8 mx-auto"
                    data-aos="fade-up" data-aos-duration="1100" data-aos-delay="200">
...
<section class="py-5 px-4 bg-white">
    <div class="container-xl">
        ...
        @php
            $manfaat = [
                ['judul' => 'Membersihkan Harta', 'deskripsi' => 'Menyucikan harta dan menjadikannya halal serta penuh berkah.', 'image' => 'harta.png', 'bg' => 'linear-gradient(to bottom right, #0d6efd, #0dcaf0)'],
                ['judul' => 'Membersihkan Jiwa', 'deskripsi' => 'Menghilangkan sifat kikir dan menumbuhkan empati sosial.', 'image' => 'jiwa.png', 'bg' => 'linear-gradient(to bottom right, #198754, #20c997)'],
                ['judul' => 'Menyempurnakan Ibadah', 'deskripsi' => 'Melengkapi rukun Islam dan mendekatkan diri kepada Allah.', 'image' => 'ibadah.png', 'bg' => 'linear-gradient(to bottom right, #ffc107, #fd7e14)'],
                ['judul' => 'Melipatgandakan Rezeki', 'deskripsi' => 'Allah menjanjikan balasan berlipat bagi orang yang berinfaq.', 'image' => 'rezeki.png', 'bg' => 'linear-gradient(to bottom right, #6f42c1, #d63384)'],
                ['judul' => 'Menghapus Dosa', 'deskripsi' => 'Sedekah ikhlas dapat menggugurkan dosa sebagaimana air memadamkan api.', 'image' => 'dosa.png', 'bg' => 'linear-gradient(to bottom right, #dc3545, #fd7e14)'],
                ['judul' => 'Menolak Bala', 'deskripsi' => 'Infaq menjadi perisai dari musibah dan keburukan.', 'image' => 'menolak.png', 'bg' => 'linear-gradient(to bottom right, #0dcaf0, #3d8bfd)'],
            ];
        @endphp
        ...
        <div class="row g-4 justify-content-center">
            @foreach ($manfaat as $index => $item)
                <div class="col-12 col-md-6 col-lg-4"
                    data-aos="fade-up" data-aos-delay="{{ 100 * ($index + 1) }}" data-aos-duration="800">
                    
                    <div class="card h-100 feature-card rounded-4 shadow-sm">
                        <div class="card-body p-4 text-center text-md-start">
                            <div class="icon-wrapper shadow-sm mx-auto mx-md-0" style="background-image: {{ $item['bg'] }};">
