    ...
    <div class="container position-relative">
        <div class="row justify-content-center text-center">
            ...
            <div class="col-lg-10">
                ...
                <p class="lead text-white-50 mb-0 col-lg-8 mx-auto"
        ...
        <div class="col-lg-12 mb-4" data-aos="fade-up" data-aos-duration="1000">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white py-3 border-0">
                    <h5 class="fw-bold mb-0"><i class="fa-solid fa-chart-column me-2 text-warning"></i> Grafik Arus Kas (Tahun Ini)</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1200">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0"><i class="fa-solid fa-clock-rotate-left me-2 text-info"></i> Riwayat Transaksi Terbaru</h5>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-4 fw-medium">{{ \Carbon\Carbon::parse($item->transaction_date)->translatedFormat('d M Y') }}</td>
                                    <td>
                                    ...
                                    <td>
                                        @if($item->type == 'pemasukan')
                                            <span class="text-success fw-bold small"><i class="fa-solid fa-arrow-down me-1"></i> Masuk</span>
                                        @else
                                            <span class="text-danger fw-bold small"><i class="fa-solid fa-arrow-up me-1"></i> Keluar</span>
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    <td colspan="5" class="text-center text-muted py-5">
                                        <img src="{{ asset('assets/images/no-data.png') }}" alt="Kosong" style="max-width: 100px; opacity: 0.6;">
