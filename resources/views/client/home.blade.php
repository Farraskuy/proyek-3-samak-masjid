    ...
    <div class="container-xl">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-12 col-md-6 col-lg-3"
                data-aos="zoom-in" data-aos-delay="100" data-aos-duration="900">
            ...
            {{-- CARD 3 --}}
            <div class="col-12 col-md-6 col-lg-3"
                data-aos="zoom-in" data-aos-delay="300" data-aos-duration="900">
            ...
            {{-- CARD 4 --}}
            <div class="col-12 col-md-6 col-lg-3"
                data-aos="zoom-in" data-aos-delay="400" data-aos-duration="900">
            ...
            <div class="row g-4">
                @foreach ($posts as $post)
                    <div class="col-md-6"
                        ...
                        <a href="{{ route('client.berita.detail', $post->slug ?? $post->id) }}" class="text-decoration-none text-dark card-link">
                            <div class="card h-100 shadow-sm article-card">
                                <div class="card-body d-flex flex-column">

                                    <div class="card-thumbnail-wrapper mb-3">
                                        <img src="{{ $post->featured_image_url ? asset('storage/' . $post->featured_image_url) : '' }}" alt="{{ $post->title }}">
                                    ...
                                    <div>
                                        ...
                                        <p class="card-text text-muted small">{{ Str::limit($post->keterangan ?? strip_tags($post->content), 110) }}</p>
                                    </div>

                                    <div class="mt-auto pt-3">
                                        <small class="text-muted">{{ optional($post->creator)->name ?? 'Admin' }} • {{ $post->created_at->format('d M Y') }}</small><br>
