    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
                ...
                <div class="text-center mb-5">
                    <div class="d-inline-block position-relative">
                        ...
                        <div class="position-absolute bottom-0 start-50 translate-middle-x" 
                             style="width: 60%; height: 4px; background: linear-gradient(90deg, transparent, #F6C948, transparent); border-radius: 10px;"></div>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden" 
                ...
                <!-- Poster -->
                @if ($event->poster)
                    <div class="text-center bg-light" style="padding: 2rem;">
                ...
                <div class="card-body p-5">
                    ...
                    @if ($event->theme)
                        <div class="mb-5">
                            <div class="card border-0 rounded-4" style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%);">
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="theme-content" style="color: #334155; font-size: 1rem; line-height: 1.8;">
                                                {{ $event->theme }}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 mt-1" style="color: #175C9E; font-size: 1.1rem;">
                                            <i class="fas fa-clock me-2"></i>{{ date('H:i', strtotime($event->start_time)) }} WIB
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 mt-1" style="color: #7b1fa2; font-size: 1.1rem;">
                                            <i class="fas fa-clock me-2"></i>{{ date('H:i', strtotime($event->end_time)) }} WIB
                                        </p>
                                    </div>
                                </div>
                            </div>
