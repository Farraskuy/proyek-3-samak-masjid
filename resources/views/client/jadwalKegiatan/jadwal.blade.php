        ...
        <div class="col-12">
            <div data-aos="fade-up" data-aos-duration="700">
                ...
                @forelse ($events as $index => $event)
                    <div class="card border-0 shadow-sm rounded-4 mb-3 hover-lift"
                                ...
                                <div class="col-md-9">
                                    ...
                                    @if($event->tamuUndangan->count() > 0)
                                        <p class="mb-2 text-muted small">
                                            ...
                                            <span class="fw-semibold">{{ $event->tamuUndangan->implode('nama_tamu', ', ') }}</span>
                                        </p>
                                    @endif
    ...
    flatpickr("#calendar", {
        ...
        onChange: function(selectedDates, dateStr) {
            ...
            fetch(`/jadwal-kegiatan/by-date?date=${dateStr}`)
                ...
                .catch(() => container.innerHTML = '<div class="alert alert-danger">Gagal memuat</div>');
        }
    });
