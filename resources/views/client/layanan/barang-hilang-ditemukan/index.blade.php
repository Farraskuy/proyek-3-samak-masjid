...
<section class="py-5">
    <div class="container">
        ...
        <ul class="nav nav-tabs justify-content-center mb-4">
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('layanan.barang-hilang') && !request()->filled('tab') || request('tab') == 'lost' ? 'active' : '' }}"
                        ...
                        <div class="card-body pt-0 d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                <span class="badge bg-warning text-dark rounded-pill px-3 py-2">
                                    <i class="fas fa-exclamation-circle me-1"></i> Hilang
                                </span>
                            </div>
                            <button class="btn btn-outline-success w-100 mt-3 rounded-pill" data-bs-toggle="modal"
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                @if ($item->photos->first())
                                <img src="{{ asset('storage/' . $item->photos->first()->image_url) }}" class="rounded">
                                @else
                                ...
                                <div class="carousel-inner rounded-4 shadow-sm">
                                    ...
                                    <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                        <img src="{{ asset('storage/' . $photo->image_url) }}"
                                            class="d-block w-100" style="max-height:400px; object-fit:contain;">
                                    </div>
                                    @endforeach
                                </div>
