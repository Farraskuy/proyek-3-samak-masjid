...
@section('content')
@php
    $webInfo = \App\Models\WebsiteInformation::first();
    $contactPhone = $webInfo->footer_phone_number ?? '08123456789';
@endphp
    ...
    <div class="container">
        ...
        @if (!request()->filled('tab') || request('tab') == 'lost')
            ...
            <div class="alert alert-info border-0 shadow-sm rounded-4 mb-4 d-flex align-items-center" data-aos="fade-up">
                ...
                <div>
                    <strong>Info Jamaah:</strong> Berikut adalah daftar barang yang hilang. Jika Anda menemukannya, silakan hubungi Divisi Sarpras atau hubungi no <strong>{{ $contactPhone }}</strong>.
                </div>
            </div>
                            ...
                            <div class="modal-content shadow-lg">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="alert alert-warning mt-3 mb-0 d-flex align-items-center">
                                        ...
                                        <small class="lh-sm">Jika Anda menemukan barang ini, hubungi bagian SarPras atau hubungi no ini <strong>{{ $contactPhone }}</strong>.</small>
                                    </div>
                                </div>
        ...
        @else
            ...
            <div class="alert alert-info border-0 shadow-sm rounded-4 mb-4 d-flex align-items-center" data-aos="fade-up">
                <i class="fas fa-info-circle fs-4 me-3"></i>
                <div>
                    <strong>Info Jamaah:</strong> Berikut adalah daftar barang yang ditemukan. Silakan hubungi Divisi Sarpras jika merasa pemiliknya atau hubungi no <strong>{{ $contactPhone }}</strong>.
                </div>
            </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content shadow-lg">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="alert alert-warning mt-3 mb-0 d-flex align-items-center">
                                        <i class="fas fa-exclamation-triangle me-2"></i>
                                        <small class="lh-sm">Hubungi bagian SarPras untuk pengambilan atau hubungi no ini <strong>{{ $contactPhone }}</strong>.</small>
                                    </div>
                                </div>
                                <div class="modal-footer border-0">
