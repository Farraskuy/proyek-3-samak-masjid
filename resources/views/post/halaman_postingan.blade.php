...
.filter-form {
    display: flex;
    justify-content: flex-end; /* Ini kuncinya: mendorong isinya ke kanan */
       margin-top: 1%;
    margin-bottom: 1%;
    margin-right: 5%;     /* Ini memberi jarak ke postingan di bawah */
}

/* CSS LAMA ANDA YANG DIMODIFIKASI */
.filter-container {
    /* float: right;  <-- HAPUS INI */
    
    display: flex;
    align-items: center; 
    
    /* margin-bottom: 20px; <-- HAPUS INI (sudah pindah ke .filter-form) */

    /* Ini untuk "diberi jarak" dari ujung kanan */

     /* Atur jaraknya di sini (misal: 10px) */
}

/* Style sisanya sudah bagus, tidak perlu diubah */
...
<form action="/postingan" method="GET" class="filter-form">
