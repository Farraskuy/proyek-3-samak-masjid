...
.filter-container {
    /* Menggunakan float untuk memposisikan ke kanan */
    float: right; 
    
    /* Menggunakan flexbox untuk merapikan label dan select */
    display: flex;
    align-items: center; /* Menjaga agar sejajar secara vertikal */
    margin-bottom: 20px; /* Memberi jarak dari konten di bawahnya */
}

.filter-container label {
    margin-right: 10px; /* Jarak antara teks "filter" dan box-nya */
    font-size: 1.1em;
    font-weight: bold;
    color: #333;
}
...
.filter-container select {
    ...
    border-bottom: 2px solid #333; /* Border bawah seperti di wireframe */
    background-color: transparent; /* Transparan agar menyatu */
    cursor: pointer;

    /* Menambahkan panah dropdown kustom */
    /* Ini adalah SVG inline untuk panah ke bawah */
    ...
    padding-right: 35px; /* Memberi ruang untuk panah */
}
